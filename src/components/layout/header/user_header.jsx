            ...
            <div className="layout-container flex items-center gap-3">
                ...
                <div className="options flex gap-3 items-center">
                    ...
                    <Link to={'/cart'} className="relative hidden sm:flex">
                        ...
                        <span className="absolute top-0 -right-2 bg-primary rounded-full w-3.5 h-3.5 text-[11px] flex items-center justify-center">{countCartItem || 0}</span>
                    </Link>
                    <Link to={'/favorite'} className="relative hidden sm:flex">
                        <MdFavoriteBorder size={28} className="text-[#494949] cursor-pointer" />
                        <span className="absolute top-0 -right-2 bg-primary rounded-full w-3.5 h-3.5 text-[11px] flex items-center justify-center">{count}</span>
                    </Link>
                </div>
            </div>
        </div>
